...
<div id="register" class="box">
	...
	<div class="content">
	   <%-- <form method="post" action="users/register">
		...
		<f:form method="post" action="users/register" modelAttribute="user">
			<dl>
				<dt>用户名：</dt>
				<dd>
				...
				<dt>确认密码：</dt>
				<dd>
					<f:password path="confirmPassword" class="input-text" name="confirmPassword" required="required" placeholder="确认密码"/>
					<f:errors path="confirmPassword" cssClass="error"/>
				</dd>
				<dt>电子邮箱：</dt>
				<dd><f:input path="vuEmail" class="input-text" name="vuEmail" required="required" placeholder="请输入邮箱" /></dd>
				<dt></dt>
				<dd><input type="submit" class="input-button" value="" /></dd>
			</dl>
		</f:form>
